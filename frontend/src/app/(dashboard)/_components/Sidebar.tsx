...
const Sidebar = () => {
   return (
      <aside
         ...
         className='z-40 h-full w-64 -translate-x-full transition-transform sm:translate-x-0'
         aria-label='Sidebar'
      >
               ...
               <li>
                  ...
                  <ul id='dropdown-example' className='space-y-2 py-2'>
                     <li>
                        ...
                        >
                           Products
                           <span className='ml-auto inline-flex h-3 w-3 items-center justify-center rounded-full bg-blue-100 p-3 text-sm font-medium text-blue-800'>
                              3
                           </span>
                        </a>
                     </li>
